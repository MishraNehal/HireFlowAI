...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('admin', 'hr', 'recruiter', 'viewer',
    ...
    op.create_table(
        ...
        sa.Column('location', sa.String(255), nullable=True),
        sa.Column('work_mode', sa.Enum('remote', 'hybrid', 'onsite',
                                        name='workmode'), nullable=True),
        sa.Column('status', sa.Enum('draft', 'active', 'paused',
                                     'completed', 'cancelled',
                                     name='campaignstatus'),
    ...
    op.create_table(
        ...
        sa.Column('interview_mode', sa.Enum('ai_only', 'human_only',
                                             'ai_and_human',
                                             name='interviewmode'),
                  nullable=True),
        sa.Column('status', sa.Enum('pending', 'active', 'completed',
                                     'skipped', name='roundstatus'),
    ...
    op.create_table(
        ...
        sa.Column('tier', sa.Enum('tier1', 'tier2', 'tier3',
                                   name='collegetier'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('recommended', 'approved', 'contacted',
                                     'confirmed', 'declined', 'removed',
                                     name='campaigncollegestatus'),
    ...
    op.create_table(
        ...
        sa.Column('parse_status', sa.Enum('pending', 'parsed', 'failed',
                                           name='parsestatus'),
                  nullable=False, server_default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('recommendation', sa.Enum('strong_match', 'moderate_match',
                                             'weak_match',
                                             name='scorerecommendation'),
                  nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('scheduled', 'started', 'completed',
                                     'no_show', 'cancelled',
    ...
    op.create_table(
        ...
        sa.Column('recommendation', sa.Enum('hire', 'hold', 'reject',
                                             name='interviewrecommendation'),
                  nullable=True),
        sa.Column('evaluated_by', sa.Enum('ai', 'human', 'both',
                                           name='evaluatedby'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('recipient_type', sa.Enum('college', 'candidate',
                                             name='recipienttype'), nullable=True),
        sa.Column('email_type', sa.String(100), nullable=True),
        sa.Column('subject', sa.Text(), nullable=True),
        sa.Column('body', sa.Text(), nullable=True),
        sa.Column('status', sa.Enum('pending', 'sent', 'failed', 'bounced',
                                     name='emailstatus'),
                  nullable=False, server_default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('draft', 'approved', 'sent',
    ...
    op.create_table(
        ...
        sa.Column('candidate_id', postgresql.UUID(as_uuid=True),
                  sa.ForeignKey('candidates.id'), nullable=False),
        sa.Column('doc_type', sa.Enum('aadhaar', 'pan', 'marksheet',
                                       'offer_signed', 'bank_details',
                                       'photo', 'other',
                                       name='doctype'), nullable=False),
        sa.Column('file_url', sa.String(500), nullable=True),
        sa.Column('status', sa.Enum('pending', 'submitted', 'verified',
                                     'rejected', name='docstatus'),
                  nullable=False, server_default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('doc_type', sa.Enum(
            ...
            name='knowledgedoctype'), nullable=False),
        sa.Column('role_tag', sa.String(100), nullable=True),
        sa.Column('content', sa.Text(), nullable=False),
        sa.Column('source', sa.Enum('synthetic', 'real',
